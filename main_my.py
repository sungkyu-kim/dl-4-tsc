...
def main_test(test_num, classifier_list, time_step_size, colum_list, error_list):
    ...
    save_infomation(output_dir, date_str, test_num, classifier_list, time_step_size, colum_list)

    if test_num == 0 :
        data_dir = DB_FILE_NAME[test_num]        
    else :        
        data_dir = RESULT_DIR + test_str + "/data/"
        create_data(DB_FILE_NAME[test_num], data_dir, output_dir, time_step_size, colum_list, error_list)
    ...
    for classifier_name in classifier_list :
        ...
        output_directory = output_dir + classifier_name + '/'
        ...
        if os.path.exists(test_dir_df_metrics):
            ...
            save_information_done(output_dir, classifier_name)
    return
...
main_test(TEST_NUM, classifier_list, TIME_STEP_SIZE, COLUM_LIST, ERROR_LIST)